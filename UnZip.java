...
public class UnZip {
    ...
    public static void main(String[] argv){
        ...
        for (int i=0;i<argv.length;i++){
            ...
            if (candidate.endsWith(".zip")||candidate.endsWith(",jar"))u.unZip(candidate);
    ...
    public void unZip(String fileName){
        ...
        try{
            zipyyy = new ZipFile(fileName);
            Enumeration all = zipyyy.entries();
    ...
    protected void getFile(ZipEntry e)throws IOException{
        ...
        switch (mode){
            case EXTRACT:
                ...
                if(ix>0){
                    ...
                    if (! dirsMade.contains(dirName)){
                        ...
                        if (!(d.exists()&&d.isDirectory())){
                            ...
                            if (!d.mkdirs()){
                                System.out.println("Waring: unable to mkdirs"+dirName);
                            }
                ...
                InputStream is = zipyyy.getInputStream(e);
                int n = 0;
                while((n=is.read(b))>0)
                    os.write(b,0,n);
                is.close();
